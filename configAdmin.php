                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <div id="add-product">
                            ...
                            <form role="form" action="app/regproducto.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <div id="del-prod-form">
                            <h2 class="text-danger text-center"><small><i class="fa fa-trash-o"></i></small>&nbsp;&nbsp;Eliminar un producto</h2>
                             <form action="app/delprod.php" method="post" role="form">
                                 <div class="form-group">
                                        ...
                                        while($prod=mysqli_fetch_array($productos)){
                                            echo '
                                                <div id="update-product">
                                                  <form method="post" action="app/updateproducto.php" id="res-update-product-'.$upr.'">
                                                    <tr>
                                                        <td>
                ...
                <div role="tabpanel" class="tab-pane fade" id="Proveedores">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <div id="add-provee">
                            ...
                            <form action="app/regprove.php" method="post" role="form">
                                <div class="form-group">
                                    <label>RUC</label>
                                    <input class="form-control" type="text" name="prove-nit" placeholder="RUC proveedor" maxlength="30" required="">
                                </div>
                                <div class="form-group">
                                    <label>Nombre</label>
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <div id="del-prove">
                            ...
                            <form action="app/delprove.php" method="post" role="form">
                                <div class="form-group">
                                              ...
                                              while($prov=mysqli_fetch_array($proveedores)){
                                                  echo '
                                                      <div id="update-proveedor">
                                                        <form method="post" action="app/updateProveedor.php" id="res-update-prove-'.$up.'">
                                                          <tr>
                                                              <td>
                                                                <input class="form-control" type="hidden" name="nit-prove-old" required="" value="'.$prov['RUCProveedor'].'">
                                                                <input class="form-control" type="text" name="nit-prove" maxlength="30" required="" value="'.$prov['RUCProveedor'].'">
                                                              </td>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            ...
                            <div id="add-categori">
                                ...
                                <form action="app/regcategori.php" method="post" role="form">
                                    <div class="form-group">
                                        <label>Código</label>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            ...
                            <div id="del-categori">
                                ...
                                <form action="app/delcategori.php" method="post" role="form">
                                    <div class="form-group">
                                              ...
                                              while($cate=mysqli_fetch_array($categorias)){
                                                  echo '
                                                      <div id="update-category">
                                                        <form method="post" action="app/updateCategory.php" id="res-update-category-'.$ui.'">
                                                          <tr>
                                                              <td>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            ...
                            <div id="add-admin">
                                ...
                                <form action="app/regAdmin.php" method="post" role="form">
                                    <div class="form-group">
                                        <label>Nombre</label>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            ...
                            <div id="del-admin">
                                ...
                                <form action="app/deladmin.php" method="post" role="form">
                                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div id="del-pedido">
                                ...
                                <form action="app/delPedido.php" method="post" role="form">
                                    <div class="form-group">
                                        <label>Pedidos</label>
                                            ...
                                            while($peU=mysqli_fetch_array($pedidoU)){
                                                echo '
                                                    <div id="update-pedido">
                                                      <form method="post" action="app/updatePedido.php" id="res-update-pedido-'.$upp.'">
                                                        <tr>
