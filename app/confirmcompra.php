...
if($num>0){
  ...
  consultasSQL::InsertSQL("venta", "Fecha, cedula, Descuento, TotalPagar, Estado", "'".date('d-m-Y')."','".$nitC."','0','".$_SESSION['sumaTotal']."','".$StatusV."'");
  
  /*recuperando el número del pedido actual*/
  $verId=ejecutarSQL::consultar("select * from venta where cedula='$nitC' order by NumPedido desc limit 1");
