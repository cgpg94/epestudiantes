        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                  <h1>REGISTRO DE USUARIO <small class="tittles-pages-logo"></small></h1>
                </div>
                       ...
                       <form class="form-horizontal FormCatElec" action="app/regclien.php" role="form" method="post" data-form="save">
                           <div class="form-group">
                              <div class="input-group">
                                ...
                                <input class="form-control all-elements-tooltip" type="text" placeholder="Ingrese su número de cédula" required name="clien-nit" data-toggle="tooltip" data-placement="top" title="Ingrese su número de cedula. Solamente números y guiones(-)" maxlength="30" pattern="[0-9-]{10,15}">
                              </div>
                            </div>
                            <br>
                            <div class="form-group">
